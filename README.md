...
## 游戏截图
<img src=".screenshot/1.png" style='width: 600px;'/>
<img src=".screenshot/2.png" style='width: 600px;'/>
<img src=".screenshot/3.png" style='width: 600px;'/>

## 环境配置
请根据你自己的平台（Linux、MacOS、Windows）参考各自的配置方法。
<img src=".screenshot/de0aeb654956613ce73dfbe60156be34.png" />
